...
export const projectsData = [
    ...
    },
    {
        id:3 ,
        name: 'SaaS',
        description: "I built a sleek, efficient SaaS landing page using React, JS, and CSS. Discover seamless productivity with our intuitive design and powerful functionality. Welcome to a new era of streamlined workflow.",
        tools: ['Reactjs', 'Vercel', 'CSS',  "JavaScript", "HTML"],
        role: 'Full Stack Developer',
        link: 'https://saas-landing-page-eta-three.vercel.app/',
        code: '',
        demo: '',
        image: ''
    },
